...
<!-- more -->
## 推荐一些个人使用的 Arch Linux 软件

使用 Arch Linux 有一段时间了，安装了很多软件，和大家分享一下。我使用的桌面环境是 Gnome，所以会偏向 GTK 软件，软件名称参考 pacman 和 AUR 仓库。
...
- [papirus-folders-git](https://github.com/PapirusDevelopmentTeam/papirus-folders) - 允许 Papirus 修改文件夹的颜色。

### 鼠标指针主题

- [vimix-cursors](https://github.com/vinceliuice/Vimix-cursors) - 这是一个受 Material Design 启发的 x 光标主题， 基于 capitaine-cursors。 
- [bibata-cursor-theme](https://github.com/ful1e5/Bibata_Cursor) - Bibata 是一个开源、紧凑、Material Design 的光标集，旨在改善用户的光标体验。
...
- [gopeed-bin](https://gopeed.com/zh-CN) - 一款支持全平台的下载器，开源、轻量、原生，支持（HTTP、BitTorrent、Magnet 等）协议下载。
...
- [fsearch](https://cboxdoerfer.github.io/fsearch) - 一个快速的文件搜索 GUI 实用程序。
